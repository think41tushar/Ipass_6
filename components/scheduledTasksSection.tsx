...
export const ScheduledTasksSection: React.FC<ScheduledTasksSectionProps> = ({ tasks, deleteTask }) => {
  console.log("Rendering ScheduledTasksSection");
      ...
      {tasks.length > 0 ? (
        <div className="space-y-4">
          {tasks.map((task) => {
            ...
            const recurrenceLabel = getRecurrenceLabel(task.recurrenceType);
            console.log("Recurrence Label:", recurrenceLabel);
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center">
                    <Badge className={cn("mr-2 bg-purple-600 text-white", statusColor)}>
