...
const PromptScheduler: React.FC = () => {
  ...
  async function callPrompt(input: string, session_id: string, isRerun: boolean) {
    let updated = ""
      ...
      <Card className="border border-gray-800 bg-[#0f1219] shadow-xl overflow-hidden rounded-lg">
        <CardHeader className="pb-2 border-b border-gray-800">
          <CardTitle className="flex gap-8 items-center justify-between">
            ...
            <Button
              ...
              className={`${isConnected ? "bg-purple-600 hover:bg-purple-700" : "bg-gray-700 hover:bg-gray-600"} text-white transition-colors duration-200`}
            >
              {connectLoading ? (
        ...
        <CardContent className="p-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="">
            <TabsList className="bg-[#0f1219] rounded-none grid grid-cols-3 border-b border-gray-800">
              <TabsTrigger
                value="prompt"
                className="data-[state=active]:bg-[#1a1f2c] data-[state=active]:text-white data-[state=active]:border-b-2 data-[state=active]:border-purple-600 text-gray-400 rounded-none"
              >
                Prompt
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="scheduled" className="p-6 bg-[#0f1219] text-white">
        ...
        <CardFooter className="p-4 border-t border-gray-800 bg-[#0f1219]">
          <div className="flex items-center text-xs text-gray-500 justify-between w-full">
            <div className="flex items-center">
              ...
              <span>Tasks are stored locally and will persist between sessions</span>
            </div>
            <div className="flex items-center">
